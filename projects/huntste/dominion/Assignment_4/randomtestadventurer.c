...
int main(){
	...
	printf("Test initializing for adventurerCard");
	...
	printf("\nIn 1000 rounds of random testing, adventurer card produced %d errors.\n", errorCount);

	printf("This ends the test of adventurer card.\n");
	return 0;
}
